...
Do not recover a version with no published crate. For the selected four- or
...
complete missing forge objects while verifying every existing object. The
single-crate traits case requires its crate to be published before recovery.
Any inconsistent
